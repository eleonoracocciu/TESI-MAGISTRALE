...
if __name__ == '__main__':
	...
	output_model_name = "{}_best_model_bert_finetuning.pickle".format(args.name)
	...
	if args.path_results:
		with open('{}{}_diz_bert_finetuning.pickle'.format(args.path_results, args.name), 'wb') as handle:
			pickle.dump(diz_final, handle)

	else:
		with open('{}_diz_bert_finetuning.pickle'.format(args.name), 'wb') as handle:
			pickle.dump(diz_final, handle)
