...
if __name__ == '__main__':
	...
	subprocess.check_call(['python3', './BERT_SVM_classification_features_normalizzate.py', '--training_set', \
	...
	subprocess.check_call(['python3', './BERT_SVM_classification_features_normalizzate.py', '--training_set', \
		...
		'--test_set', 'df_random_speech_test_bert_features_for_layers.pickle', '--name', 'df_random_speech'])
