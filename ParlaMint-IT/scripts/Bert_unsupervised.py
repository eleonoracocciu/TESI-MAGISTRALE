...
if __name__ == '__main__':
	...
	save_dataframe("{}_cosine_distance".format(args.name), df_cosine_distance, path_results)

	#salvo il dizionario con id_evento - distanza cosenica per ogni livello
	with open('{}_{}_diz_ids_cosine_distances.pickle'.format(path_results, args.name), 'wb') as handle:
