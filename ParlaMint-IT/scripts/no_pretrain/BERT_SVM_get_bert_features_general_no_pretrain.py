...
if __name__ == '__main__':
	...
	if args.path_results:
		with open('{}{}_bert_features_for_layers_no_pretrain.pickle'.format(args.path_results, df_name_training), 'wb') as handle:
			pickle.dump(training_features_for_layers, handle)

		with open('{}{}_bert_features_for_layers_no_pretrain.pickle'.format(args.path_results, df_name_test), 'wb') as handle:
			pickle.dump(test_features_for_layers, handle)

	else:
		with open('{}_bert_features_for_layers_no_pretrain.pickle'.format(df_name_training), 'wb') as handle:
			pickle.dump(training_features_for_layers, handle)

		with open('{}_bert_features_for_layers_no_pretrain.pickle'.format(df_name_test), 'wb') as handle:
			pickle.dump(test_features_for_layers, handle)
