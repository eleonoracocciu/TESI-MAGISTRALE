...
def save_dataframe(file_name, dataframe_to_save, path_results):
	
	try:
		dataframe_to_save.to_csv(path_results+file_name+".csv", index = False, sep = "\t")
...
if __name__ == '__main__':
	...
	with open('{}_{}_diz_ids_cosine_distances_no_pretrain.pickle'.format(path_results, args.name), 'wb') as handle:
